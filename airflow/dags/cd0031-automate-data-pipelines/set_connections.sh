...
#
airflow connections add aws_credentials --conn-uri 'aws://AKIAVUXGF3GLVZHVS4OW:W%2BxKZMzGzh0S%2Fd0cxIWIBmuxUuWEuLHBdt4h6Q0S@'
#
#
# TO-DO: run the follwing command and observe the JSON output: 
...
airflow variables set s3_bucket ashwin-course-aws
#
